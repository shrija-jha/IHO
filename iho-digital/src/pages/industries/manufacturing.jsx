...
const themePalette = { slate: { gradient: "from-slate-950 via-slate-900 to-black", accent: "bg-slate-600", text: "text-slate-400", border: "border-slate-500/30", glow: "bg-slate-500/20", hex: "#64748b", titleGradient: "from-slate-300 via-slate-500 to-zinc-400" } };
const theme = themePalette.slate;
