...
const ServicePage = () => {
  ...
  const relatedServices = useMemo(() => {
    return industriesData
      .filter(s => s.category === service?.category && s.id !== 'photography')
      .slice(0, 4);
