...
const ServicePage = () => {
  ...
  const relatedServices = useMemo(() => {
    return industriesData
      .filter(s => s.category === service?.category && s.id !== 'human-resources')
      .slice(0, 4);
